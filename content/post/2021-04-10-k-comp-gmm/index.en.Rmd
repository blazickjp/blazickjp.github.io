---
title: "Extending the Gibbs Sampler to K-Components"
...
```{r, echo=FALSE, fig.align='center', out.height="75%", out.width="75%"}
knitr::include_graphics("mix4.png")
```
