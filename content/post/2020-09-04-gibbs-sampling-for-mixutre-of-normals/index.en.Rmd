...
from $\phi_{\theta_2}(x)$ where $\phi_{\theta_2}(x) \sim N(\mu_2, \sigma^2_2)$. @blei2015 Using python we can show this as follows:
...
knitr::include_graphics("gauss_mixtures.png")
```
...
```{r, echo=FALSE, fig.align='center', out.height="75%", out.width="75%"}
knitr::include_graphics("mixture_fitted.png")
```
...
```{r, echo=FALSE, fig.align='center', out.height="75%", out.width="75%"}
knitr::include_graphics("m2g_trace.png")
```
